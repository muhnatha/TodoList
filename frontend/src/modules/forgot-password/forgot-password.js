  ...
  return (
    <div className='flex flex-col items-center min-h-screen justify-center relative'>
      <div className='fixed top-0 left-2 m-3'>
        <Link href='/login' className='text-white font-semibold hover:underline'>← Back to login</Link>
      </div>
      ...
      <form onSubmit={handleSubmit} className='p-4'>
        <h1 className='text-center font-bold text-3xl mb-3 px-20'>RESET YOUR PASSWORD</h1>
        <div className='flex flex-col gap-5'>
          ...
          <div className='flex flex-col gap-2 justify-center items-center'>
            ...
            <button type="submit" className='justify-center rounded-sm py-1 w-full hover:cursor-pointer bg-[#5051F9]/50'><span className='font-semibold'>RESET PASSWORD</span></button>
          </div>
        </div>
      </form>
    </div>
